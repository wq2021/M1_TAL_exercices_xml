					...
					<div class="container">
						<article id="main" class="special">
							<header>
								...
								<p></p>
								<p><xsl:value-of select="page/corps/reponse/p2"/></p>
								<p><xsl:value-of select="page/corps/reponse/p3"/></p>
								<p><xsl:value-of select="page/corps/reponse/p4"/></p>
								<p><xsl:value-of select="page/corps/reponse/p5"/></p>
								<p><xsl:value-of select="page/corps/reponse/p6"/></p>
								<p><xsl:value-of select="page/corps/reponse/p7"/></p>
								<p align="center"><a href="exercices/3/final/exo3.xml" class="button" target="blank">Résultat : XML</a></p>
