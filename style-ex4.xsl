					...
					<div class="container">
						<article id="main" class="special">
							<header>
								...
								<p align="center"><a href="exercices/4/TEI2TablePremiersVers.xsl" style="margin-right:15px;" class="button" target="blank">XSLT : TEI2TablePremiersVers</a>
								<a href="exercices/4/Premier.html" style="margin-right:15px;" class="button" target="blank">Srotie HTML : TEI2TablePremiersVers</a></p>

								<p align="center"><a href="exercices/4/NombreVers.xsl" style="margin-right:15px;" class="button" target="blank">XSLT : NombreVers</a>
								<a href="exercices/4/Nombre.html" style="margin-right:15px;" class="button" target="blank">Srotie HTML : NombreVers</a></p>
